...
void Game::GenerateOutput()
{
	...
	glClearColor(Math::Lamp(Math::Sin(mColor*Math::Pi/12.0f)), Math::Lamp(Math::Sin(mColor*Math::Pi / 12.0f - Math::Pi/2.0f)), Math::Lamp(Math::Sin(mColor*Math::Pi / 12.0f - Math::Pi)), 1.0f);
